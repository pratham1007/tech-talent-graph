...
A graph database application that maps developers, their skills, the projects they've worked on, and the companies they've worked at — then answers relationship-centric questions that are natural in a graph and awkward in SQL.
...
_Add screenshots of the Developers, Skills, Skill Bridges, and Projects pages here._

---

## Hosting

The app can be deployed to any platform that runs Python. For a free tier:

- **Railway / Render**: push the repo, set the three env vars (`COGNODB_URI`, `COGNODB_USER`, `COGNODB_PASSWORD`), and deploy.
